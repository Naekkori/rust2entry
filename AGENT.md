...
카테고리별 (✅/전체): 시작 13/26, 흐름 10/15, 움직임 0/19, 형태 17/17 (완료), 붓 0/13, 텍스트 0/9, 소리 0/16, 판단 3/11, 연산 12/26, 변수 10/19, 함수 7/14, 데이터분석 0/18.
...
**다음 할 일 추천 순서**:
1. 변수 — 리스트 (값 추가/삭제/길이) — 5블록, 변수 10/19 → 15/19
